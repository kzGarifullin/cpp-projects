...
int main(int argc, char** argv)
{
	system("chcp 1251");
	exit_flag_w = false;
	std::string raw_ip_address = "127.0.0.1"; //93.175.8.189
	...
	try
	{
		...
		Sprite sBackground(texture);
			...
			Player p1 = { 300, M * 0.95, Color::Red };
			Player p2 = { 300,M * 0.05,Color::Green };
			...
			while (window.isOpen())
			{
				...
				if (Keyboard::isKeyPressed(Keyboard::Left)) if (direction1 != Direction::right) 
				{ 
					direction1 = Direction::left; 
				    //give(socket, "LT!");
				}
				if (Keyboard::isKeyPressed(Keyboard::Right)) if (direction1 != Direction::left)
				{
					direction1 = Direction::right;
					//give(socket, "RT!");
				}
				if (Keyboard::isKeyPressed(Keyboard::Up)) if (direction1 != Direction::down)
				{
					direction1 = Direction::up;
					//give(socket, "UT!");
				}
				if (Keyboard::isKeyPressed(Keyboard::Down)) if (direction1 != Direction::up)
				{
